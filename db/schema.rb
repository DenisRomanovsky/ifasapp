...
ActiveRecord::Schema.define(version: 20_170_807_190_515) do
  ...
  add_index 'auction_subcategories', %w[auction_id mechanism_subcategory_id], name: 'auction_subcats_idx', using: :btree
  ...
  add_index 'mechanisms', %w[mechanism_category_id mechanism_subcategory_id], name: 'by_category_subcategory', using: :btree
