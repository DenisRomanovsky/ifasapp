...
module ApplicationHelper
  def user_can_participate?
    ...
    current_user.mechanisms.pluck(:mechanism_subcategory_id).include?(auction.mechanism_subcategory_ids) ||
        (auction.mechanism_subcategory_ids.nil? &&
            current_user.mechanisms.pluck(:mechanism_category_id).include?(auction.mechanism_category_ids))
  end
end